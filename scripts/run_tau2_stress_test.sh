...
#
# Key overrides:
#   WINDOW_SIZE=256 PHASE=1 bash scripts/run_tau2_stress_test.sh
...
WINDOW_SIZE="${WINDOW_SIZE:-128}"   # fixed for all streamingllm/h2o configs
...
#   Sweeps the full meaningful range (all well below AGENT_MAX_TOKENS=1024).
